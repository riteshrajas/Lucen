    ...
    try {
      ...
      if (storedMessages) {
        ...
        const welcomeMessage = storedAgenticMode
          ? 'Hello! I\'m your Agentic Athera Advisor. I can provide life guidance AND take actions for you! Try: "Create a task to call mom", "Change theme to dark", or ask for advice like "Should I learn Python?". For casual chat, just say hi!'
          : 'Hello! I\'m your Athera Advisor. Ask for advice on decisions and life choices, and I\'ll provide guidance based on your life rules. For casual conversation, just say hello!';
                  ...
                  >
                    ...
                    {msg.role === 'assistant' && !msg.content.startsWith('{') && (
                      <div className="flex items-center gap-2 mb-1 opacity-80">
                        ...
                        <span className="text-xs">Athera Advisor</span>
                      </div>
                    )}
